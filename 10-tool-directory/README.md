...
A **free tier** is an ongoing, limited option. A **trial** ends. A **student offer** has eligibility rules. **Credits** run out or expire. A plan can have **usage limits** even while it is free. Before accepting a promotion, check the claim deadline, payment method, renewal price, cancellation terms, and what happens to your work if access changes.
